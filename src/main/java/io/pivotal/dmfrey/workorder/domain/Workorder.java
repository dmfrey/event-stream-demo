...
import static io.pivotal.dmfrey.workorder.domain.WorkorderState.*;
...
public class Workorder {
    ...
    private Workorder nameUpdated( final NameUpdated event ) {
    ...
    private Workorder nodeAssigned( final NodeAssigned event ) {
    ...
    private Workorder workorderOpened( final WorkorderOpened event ) {
    ...
    private Workorder workorderStarted( final WorkorderStarted event ) {
    ...
    private Workorder workorderStopped( final WorkorderStopped event ) {
    ...
    private Workorder workorderCompleted( final WorkorderCompleted event ) {
    ...
    public static Workorder createFrom( final UUID workorderId, List<WorkorderDomainEvent> changes ) {

        return ofAll( changes ).foldLeft( new Workorder( workorderId ), Workorder::handleEvent );
    }

    private Workorder handleEvent( final WorkorderDomainEvent domainEvent ) {
