...
class CompleteWorkorderService implements CompleteWorkorderUseCase {
    ...
    @Override
    @Transactional
    public Map<String, Object> execute( CompleteWorkorderCommand command ) {
        ...
        foundWorker.completeWorkorder( user, this.nodeValidatorQuery.execute( new NodeValidatorQuery.ValidateNodeCommand() ), timestampGenerator.generate() );
