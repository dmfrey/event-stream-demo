...
class OpenWorkorderService implements OpenWorkorderUseCase {
    ...
    public void execute( OpenWorkorderCommand command ) {
        ...
        foundWorker.openWorkorder( user, this.nodeValidatorQuery.execute( new NodeValidatorQuery.ValidateNodeCommand() ), timestampGenerator.generate() );
